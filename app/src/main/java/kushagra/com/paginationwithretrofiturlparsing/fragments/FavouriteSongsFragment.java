 ...
 */
    ...
    public class FavouriteSongsFragment extends Fragment  implements PaginationAdapterCallback {
     ...
     public FavouriteSongsFragment() {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.favourite_song_fragment, container, false);
...
//            mWaveSwipeRefreshLayout.setRefreshing(false);
                if(databaseControllerAllQuery.numberOfFavoriteTuple(TABLENAME)>0) {
...
//after hide error view set visibility gone
                ...
                {
                    progressBar.setVisibility(View.GONE);
                    showErrorView(getResources().getString(R.string.error_msg_no_favorite_song));
                }
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        public void getAllFavoriteSongFromSql() {


            List<OlaData>  response= databaseControllerAllQuery.getFavoriteSongsOfPage(TABLENAME, pageNumber);
            int size=databaseControllerAllQuery.numberOfFavoriteTuple(TABLENAME);
        ...
        public void getSearchedSongFromSql(String searchQuery) {
            ...
            List<OlaData>  response= databaseControllerAllQuery.getSearchedFavouriteSongByPage(TABLENAME, pageNumber,searchQuery);
            int size=databaseControllerAllQuery.numberOfTupleInFavouriteSearchResult(TABLENAME,searchQuery);
            loadPage(response,size);
        }

        public void loadPage(List<OlaData>  response,int size) {
            Log.i("FavouriteFragment = ", "loadPage");
